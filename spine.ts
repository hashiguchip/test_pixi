 ...
 * @file spine
 * importできないのかもしれない。
 * https://github.com/pixijs/pixi-spine/issues/297
 */

import * as PIXI from "pixi.js";
window.PIXI = PIXI;
import "pixi-spine";
import spineJson from "./spine.json";
//
console.log(spineJson);

const url = "./spine.json";
...
app.loader
  .add(
    "dragon",
    "https://pixijs.io/examples/examples/assets/pixi-spine/dragon.json"
    //↓これができない たぶんjsonファイルだけだとだめなんだと思う
    //"./spine.json"
  )
  .load(onAssetsLoaded);
